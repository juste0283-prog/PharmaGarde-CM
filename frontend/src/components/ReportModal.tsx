    ...
    >
      <div className="w-full max-w-lg rounded-2xl bg-white p-6 shadow-xl sm:p-8">
        <div className="flex items-start justify-between gap-4">
          <div>
            <h2 className="text-lg font-bold text-slate-900">Signaler une anomalie</h2>
          ...
          <button
            ...
            onClick={onClose}
            aria-label="Fermer"
            className="rounded-lg px-2 py-1 text-xl leading-none text-slate-400 transition-colors hover:bg-slate-100 hover:text-slate-700"
          >
            ×
          </button>
        </div>
        ...
        <div className="mt-5 space-y-4">
          <div>
            <label htmlFor="report-type" className="mb-1.5 block text-sm font-semibold text-slate-700">
              Type de problème
            </label>
            <select
              id="report-type"
          ...
          <div>
            <label htmlFor="report-author" className="mb-1.5 block text-sm font-semibold text-slate-700">
          ...
          <div>
            <label htmlFor="report-desc" className="mb-1.5 block text-sm font-semibold text-slate-700">
              Description
            </label>
            <textarea
              id="report-desc"
          ...
          <div className="flex gap-3">
            <button
              type="button"
              onClick={onClose}
              className="flex-1 rounded-lg border border-slate-300 px-4 py-2.5 text-sm font-semibold text-slate-600 transition-colors hover:bg-slate-100"
            >
              Annuler
            </button>
            <button
